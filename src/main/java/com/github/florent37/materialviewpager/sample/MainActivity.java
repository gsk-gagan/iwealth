...
import com.github.florent37.materialviewpager.sample.fragment.GoalsScrollFragment;
...
import com.github.florent37.materialviewpager.sample.fragment.SuggestionsScrollFragment;
...
public class MainActivity extends DrawerActivity
    ...
    public static final String GOAL_VALUE_KEY = "GoalValueKey";
        ...
        mViewPager.getViewPager().setAdapter(new FragmentStatePagerAdapter(getSupportFragmentManager()) {
            ...
            public Fragment getItem(int position) {
                switch (position % 3) {
                    ...
                    case 1:
                        return GoalsScrollFragment.newInstance();
                    case 2:
                        return SuggestionsScrollFragment.newInstance();
                    default:
...
//        }
    ...
    public void retirementSuggestion(View v) {
        Toast.makeText(getApplicationContext(), "Retirement Suggestion", Toast.LENGTH_SHORT).show();
        Intent intent = new Intent(getApplication(), RetirementSuggestion.class);
