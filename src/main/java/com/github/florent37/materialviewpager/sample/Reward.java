        ...
        View.OnClickListener approveDenyListner = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(current == approveButton) {
                    Toast.makeText(Reward.this, "Savings Approved of $" + reward, Toast.LENGTH_SHORT).show();
                ...
                if(current == denyButton) {
                    Toast.makeText(Reward.this, "Savings Denied", Toast.LENGTH_SHORT).show();
                }
                Reward.this.finish();
            }
        };
